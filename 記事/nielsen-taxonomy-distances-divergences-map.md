...
本記事は地図であって、どの区画も歩いてはいない。有限の確率単体に限って Fisher–Rao の欄を実際に歩き、Bhattacharyya 角と Fisher 弧長が同じ球面の二つの正規化にすぎないことを閉じた式で確かめたのが「伊藤補正は幾何ではない ── Fisher 弧長で単体を歩き、Dirichlet 重みで境界を読む」である。あちらでは、この地図に載っていないもの ── 単体の**境界**が、どの不変量に見えてどの不変量に見えないか ── が主題になる。
